...
При нажатии не кнопку [Изменить название], бот присылает сообщение с текстом:

> Введите название шаблона

После ввода названия бот присылает информацию о шаблоне, так же как в разделе
Редактирование шаблонов, но уже с обновленными данными.

#### Изменить текст 

При нажатии не кнопку [Изменить текст], бот присылает сообщение с текстом:

> Введите текст шаблона

После ввода текста бот присылает информацию о шаблоне, так же как в разделе
Редактирование шаблонов, но уже с обновленными данными.

#### Удалить

При нажатии на кнопку [Удалить] бот присылает сообщение с текстом:
> Вы уверенны что хотите удалить шаблон?

    - Да
    - Нет

При подтверждении удаления аккаунта бот, удаляет все данные шаблона из базы данных, и присылает список шаблонов, но уже с обновленными данными.
